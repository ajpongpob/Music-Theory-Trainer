...
async function runScenario(scenario){
  ...
  if(scenario==='student'){
    ...
    check('practice-only next action rendered',get('dashboardRecommendation').innerHTML.includes('เริ่มทำแบบฝึกของขั้นนี้ตามเงื่อนไขหลักของระบบ') && get('dashboardRecommendation').innerHTML.includes('data-session-mode="practice"') && !get('dashboardRecommendation').innerHTML.includes('pretest'),get('dashboardRecommendation').innerHTML);
