...
const definition=fs.readFileSync(path.join(root,'src/exercises/major-scale/exercise.definition.js'),'utf8');

assert(definition.includes("./styles/mobile-safari-fix.css"),'Major Scale definition must load the narrow-screen Safari fix stylesheet');
...
console.log('PASS mobile Safari layout contract: Major Scale loads fix; 3-system score can grow/scroll and palette cannot overlay mobile navigation hit targets');
