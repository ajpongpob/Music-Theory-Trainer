...
const PAIRS=[
  ...
  ['ขั้นปัจจุบัน','Current Stage'],
  ['ทักษะที่ผ่านเกณฑ์','Mastered Skills'],
  ['จำนวนครั้งที่ฝึก','Practice Sessions'],
  ['ความก้าวหน้ารวม','Overall Progress'],
  ['ภาพรวมทักษะ','Skill Snapshot'],
  ['เส้นทางการเรียน','Learning Path'],
  ['ความก้าวหน้าการเรียนโดยรวม','Overall Learning Progress'],
  ['รายละเอียด Mastery รายทักษะ','Skill Mastery Detail'],
  ['แนวโน้มการเรียน','Learning Trend'],
  ['ความก้าวหน้า / ประวัติ Stage','Stage Progress / History'],
  ['ประวัติ Session','Session History'],
  ...
  ['สถานะ','Status'],
  ['แนวโน้ม','Trend'],
  ['ผลงานล่าสุด','Recent performance'],
  ['เกณฑ์ Mastery','Mastery threshold'],
  ['ทุกทักษะ','All Skills'],
  ['ดีขึ้น','Improving'],
  ['ลดลง','Declining'],
  ['คงที่','Stable'],
  ['ความก้าวหน้า Stage','Stage Progress'],
